...
### Archivo sh
Para usarla simplemente clona el repositorio, da permisos de ejecución y ejecuta el sh.
...
### Archivo .c
Puedes elegir si compilarlo por ti mismo (necesitarás cjson, ncurses y libcurl, además de las librerías por defecto de c), o usar una versión precompilada por mí que puedes encontrar en realeses.
